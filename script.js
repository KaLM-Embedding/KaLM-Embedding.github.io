...
function renderContent() {
    // 1. Hero Section
    document.getElementById('hero-title').textContent = KaLM_Content.hero.title;
    document.getElementById('hero-subtitle').textContent = KaLM_Content.hero.subtitle;
    document.getElementById('hero-description').textContent = KaLM_Content.hero.description;
    ...
    KaLM_Content.papers.forEach(paper => {
        ...
        card.innerHTML = `
            <div class="paper-header">
                ...
                ${paper.is_latest ? '<span class="paper-badge">Latest</span>' : ''}
            </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Observe all cards
    const cards = document.querySelectorAll('.feature-card, .model-card, .paper-card, .dataset-card');
